    ...
    },
    {
      ...
      content:
        `<p>Для взаимодействия с сервером в «СТ ВЕБКИТ» используется популярная библиотека <a href="https://github.com/axios/axios" target="_blank">Axios</a>.</p>
          ...
          а описание настройки процессов в BPM Online - <a href="/static/Как в бизнес процессе сделать привязку к объекту, данные которого передают из API.docx">Как в бизнес процессе сделать привязку к объекту, данные которого передают из API.docx</a>.</p>
